        ...
        private string Convert_to_words(char[] num)
        {
            ...
            while (x < num.Length)
            {
                ...
                if (len >= 3)
                {
                    if (num[x] - '0' != 0)
                    {
                        returnString += (single_digits[num[x] - '0'] + " ");
                        if ((len == 4) && (num[x + 3] != '0' || num[x + 2] != '0') || num[x + 1] != '0')
                            returnString += (tens_power[len - 3] + " ");
                        else if ((len == 3) && (num[x + 2] != '0' || num[x + 1] != '0'))
                            returnString += (tens_power[len - 3] + " ");
                        else
                            returnString += (tens_power[len - 3]);
